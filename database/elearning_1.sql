...
--
-- Host: localhost
-- Generation Time: Mar 03, 2014 at 05:15 AM
...
INSERT INTO `tb_users` (`id`, `user_name`, `real_name`, `reg_date`, `level`, `birth_date`, `email`, `phone_number`, `address`, `password`, `approve_flag`, `status_flag`, `bank_account_code`, `ip_address`, `profile_img`) VALUES
