...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2014 at 06:16 PM
...
CREATE TABLE IF NOT EXISTS `tb_question_type` (
...
INSERT INTO `test_histories` (`id`, `user_id`, `test_id`, `test_date`, `answers`, `score`) VALUES
